...
setwd('C:\\Users\\modem\\Desktop\\CapstoneProject')

f_en_us_blogs_name <- "./final/en_US/en_US.blogs.txt"
f_en_us_twitter_name <- "./final/en_US/en_US.twitter.txt"
f_en_us_news_name <- "./final/en_US/en_US.news.txt"
